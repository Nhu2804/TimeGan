...
def rnn_layer(module_name, hidden_dim, return_sequences=True):
  """Basic RNN Cell.
  ...
  # GRU
  if module_name == 'gru':
      return tf.keras.layers.GRU(hidden_dim, return_sequences=return_sequences)
  # LSTM
  elif module_name == 'lstm':
      return tf.keras.layers.LSTM(hidden_dim, return_sequences=return_sequences)
  # LSTM Layer Normalization
  elif module_name == 'lstmLN':
      # Không có LSTM layer normalization built-in → dùng LSTM thường
      return tf.keras.layers.LSTM(hidden_dim, return_sequences=return_sequences)
